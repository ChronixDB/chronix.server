...
public class DateQueryParser {
    ...
    public String replaceRangeQueryTerms(String query) throws ParseException {
        ...
        query = markQueryWithPlaceholders(query, replacements);
        query = filePlaceholders(query, replacements);
     ...
     */
    private String filePlaceholders(String query, Map<String, String> replacements) {
    ...
    private String markQueryWithPlaceholders(String query, Map<String, String> replacements) throws ParseException {
        for (int i = 0; i < dateFields.length; i++) {
            ...
            if (query.contains(dateField)) {
                ...
                query = query.replace(dateField + dateTerm, keyPart(i));
    ...
    private String getTokenTerm(String query, String startToken) {
        ...
        //TODO: Correct parsing of the end
