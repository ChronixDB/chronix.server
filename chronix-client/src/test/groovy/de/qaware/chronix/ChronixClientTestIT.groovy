...
class ChronixClientTestIT extends Specification {
    ...
    def "Test add and query documents to Chronix with embedded Solr"() {
        ...
        def chronix = new ChronixClient(new DefaultDocumentConverter())
        ...
        //query all documents
        List<BinaryStorageDocument> documentCount = chronix.stream(new SolrQuery("*:*"), start, end, embeddedClient).collect(Collectors.toList());
