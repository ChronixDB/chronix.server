...
class AnalysisQueryEvaluatorTest extends Specification {
    ...
    def "test query strings"() {
        ...
        expectedAggreation << [AnalysisType.MIN, AnalysisType.MAX, AnalysisType.AVG, AnalysisType.DEV, AnalysisType.SUM, AnalysisType.COUNT, AnalysisType.FIRST, AnalysisType.LAST, AnalysisType.P,
                               AnalysisType.TREND, AnalysisType.OUTLIER, AnalysisType.FREQUENCY, AnalysisType.FASTDTW, AnalysisType.FASTDTW]
        expectedValue << [new String[0], new String[0], new String[0], new String[0], new String[0], new String[0], new String[0], new String[0], ["percentile=0.4"] as String[],
        ...
        subQuery << [null, null, null, null, null, null, null, null, null, null, null, null, "metric:load* AND group:(A OR B)", "metric:load* AND group:(A OR B)"]
        needSubQuery << [false, false, false, false, false, false, false, false, false, false, false, false, true, true]
    }
