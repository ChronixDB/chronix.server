...
class CompactionHandlerTestIT extends Specification {
    ...
    def "test status code"() {
        given:
        solr.add([doc((START): 1, (END): 2, (NAME): 'cpu', (DATA): compress(1L: 10d, 2L: 20d))])
        solr.commit()
    ...
    def "test compaction of a small number of documents"() {
        given:
        solr.add([doc((START): 1, (END): 2, (NAME): 'cpu', (DATA): compress(1L: 10d, 2L: 20d)),
                  doc((START): 3, (END): 4, (NAME): 'cpu', (DATA): compress(3L: 30d, 4L: 40d)),
                  doc((START): 5, (END): 6, (NAME): 'cpu', (DATA): compress(5L: 50d, 6L: 60d))])
        solr.commit()
    ...
    def "test compaction of a large number of documents"() {
        ...
        (1L..100L).collate(5).each { range ->
            ...
            solr.add(doc((START): range.first(), (END): range.last(), (NAME): 'cpu', (DATA): compress(data)))
        }
        solr.commit()
    ...
    def "test special chars as value of a join key field"() {
        given:
        solr.add([doc((START): 5, (END): 6, (NAME): 'a:AND() {!$#}\\', (DATA): compress(1L: 10d))])
        solr.commit()
    ...
    def "test compaction of two time series"() {
        ...
        (1L..100L).collate(5).each { def range ->
            ...
            solr.add(doc((START): range.first(), (END): range.last(), (NAME): 'cpu', (DATA): compress(cpuData)))
            solr.add(doc((START): range.first(), (END): range.last(), (NAME): 'heap', (DATA): compress(heapData)))
        }
        solr.commit()
    ...
    def "test fq"() {
        given:
        solr.add([doc((START): 1, (END): 2, (NAME): 'cpu', host: '1', (DATA): compress(1L: 10d, 2L: 20d)),
                  doc((START): 3, (END): 4, (NAME): 'cpu', host: '1', (DATA): compress(3L: 30d, 4L: 40d)),
                  doc((START): 5, (END): 6, (NAME): 'cpu', host: '2', (DATA): compress(5L: 50d, 6L: 60d))])
        solr.commit()
    ...
    def "test fq with joinKey"() {
        given:
        solr.add([doc((START): 10, (END): 11, (NAME): 'cpu', host: '1', (DATA): compress(10L: 10d, 11L: 11d)),
                  doc((START): 12, (END): 13, (NAME): 'cpu', host: '1', (DATA): compress(12L: 12d, 13L: 13d)),
                  doc((START): 14, (END): 15, (NAME): 'cpu', host: '2', (DATA): compress(14L: 14d, 15L: 15d)),
                  doc((START): 16, (END): 17, (NAME): 'mem', host: '1', (DATA): compress(16L: 16d, 17L: 17d)),
                  doc((START): 18, (END): 19, (NAME): 'mem', host: '1', (DATA): compress(18L: 18d, 19L: 19d)),
                  doc((START): 20, (END): 21, (NAME): 'mem', host: '2', (DATA): compress(20L: 20d, 21L: 21d))])
        solr.commit()
