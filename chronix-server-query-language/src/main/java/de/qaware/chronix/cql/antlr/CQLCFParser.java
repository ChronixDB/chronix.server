...
public class CQLCFParser extends Parser {
    ...
    public static final int
            ...
            RULE_chronixfunction = 3, RULE_name = 4, RULE_parameter = 5, RULE_chronixType = 6;
    public static final String[] ruleNames = {
            "cqlcf", "chronixTypedFunctions", "chronixTypedFunction", "chronixfunction",
            "name", "parameter", "chronixType"
    };
    /**
    ...
    public final ChronixTypedFunctionsContext chronixTypedFunctions() throws RecognitionException {
        ...
        try {
            enterOuterAlt(_localctx, 1);
            {
                ...
                _la = _input.LA(1);
                while (_la == T__0 || _la == LOWERCASE_CHAR) {
                    {
                        {
                            setState(18);
                            _la = _input.LA(1);
    ...
    public final ChronixfunctionContext chronixfunction() throws RecognitionException {
        ...
        enterRule(_localctx, 6, RULE_chronixfunction);
        int _la;
        try {
            setState(51);
    ...
    public final ChronixTypeContext chronixType() throws RecognitionException {
        ...
        enterRule(_localctx, 12, RULE_chronixType);
        try {
            enterOuterAlt(_localctx, 1);
            {
                setState(60);
    ...
    public static class NameContext extends ParserRuleContext {
        ...
        public TerminalNode LOWERCASE_CHAR() {
            return getToken(CQLCFParser.LOWERCASE_CHAR, 0);
        }
    ...
    public static class ParameterContext extends ParserRuleContext {
        ...
        public List<TerminalNode> STRING_LITERAL() {
            return getTokens(CQLCFParser.STRING_LITERAL);
        }

        public TerminalNode STRING_LITERAL(int i) {
            return getToken(CQLCFParser.STRING_LITERAL, i);
        }
